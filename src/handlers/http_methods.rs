...
// Multipart handlers
pub async fn post_multipart_handler(req: HttpRequest, payload: Multipart) -> Result<HttpResponse> {
...
pub async fn put_multipart_handler(req: HttpRequest, payload: Multipart) -> Result<HttpResponse> {
    match extract_request_info_multipart(&req, payload).await {
        Ok(request_info) => Ok(HttpResponse::Ok().json(request_info)),
        Err(_) => {
            let mut request_info = extract_request_info(&req, None);
...
pub async fn patch_multipart_handler(req: HttpRequest, payload: Multipart) -> Result<HttpResponse> {
    match extract_request_info_multipart(&req, payload).await {
        Ok(request_info) => Ok(HttpResponse::Ok().json(request_info)),
        Err(_) => {
            let mut request_info = extract_request_info(&req, None);
...
pub async fn delete_multipart_handler(req: HttpRequest, payload: Multipart) -> Result<HttpResponse> {
    match extract_request_info_multipart(&req, payload).await {
        Ok(request_info) => Ok(HttpResponse::Ok().json(request_info)),
        Err(_) => {
            let mut request_info = extract_request_info(&req, None);
